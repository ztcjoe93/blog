...
date: "2023-10-31T18:07:45+08:00"
...
```
It was interesting though, as there is was a need to think of how should values be passed from the `ucd` wrapper to the builtin `cd` command, yet have the extensibility of new features.  
